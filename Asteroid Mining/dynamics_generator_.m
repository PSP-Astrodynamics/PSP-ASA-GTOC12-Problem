...
matlabFunction(xdot,"File","f_kepler_fixedtf","Vars", [{t}; {x}; {u}; {p}]);
...
matlabFunction(j_a,"File","A_kepler_fixedtf","Vars",[{t}; {x}; {u}; {p}]);
matlabFunction(j_b,"File","B_kepler_fixedtf","Vars",[{t}; {x}; {u}; {p}]);
matlabFunction(j_e,"File","S_kepler_fixedtf","Vars",[{t}; {x}; {u}; {p}]);
