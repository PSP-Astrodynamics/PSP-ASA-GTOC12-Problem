function [x_sol, u_sol, sol_info, problem] = solve_ptr_convex_subproblem_no_p_CVXPyGEN(prob, ptr_ops, x_ref, u_ref, problem)
...
if prob.Name == "Ast2Ast_fixed"
    if prob.u_hold == "ZOH"
        error("ZOH CVXPyGEN for Ast2Ast_fixed not implemented")
    ...
    elseif prob.u_hold == "FOH"
        [U, V, v_0, v_N, eta, X] = cpg_solve_wrap_Ast2Ast(... % ADD SOLVE STATUS
