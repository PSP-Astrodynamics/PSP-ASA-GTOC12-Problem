 ...
 * File: discretize_error_dynamics_FOH_kepler_fixedtf_terminate.c
 *
...
void discretize_error_dynamics_FOH_kepler_fixedtf_terminate(void)
{
  ...
  isInitialized_discretize_error_dynamics_FOH_kepler_fixedtf = false;
}

/*
 * File trailer for discretize_error_dynamics_FOH_kepler_fixedtf_terminate.c
 *
 * [EOF]
 */
