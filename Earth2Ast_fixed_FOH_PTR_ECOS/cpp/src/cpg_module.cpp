...
CPG_Result_cpp_t solve_cpp(struct CPG_Updated_cpp_t& CPG_Updated_cpp, struct CPG_Params_cpp_t& CPG_Params_cpp){
    ...
    if (CPG_Updated_cpp.Ak_14) {
        for(i=0; i<49; i++) {
            cpg_update_Ak_14(i, CPG_Params_cpp.Ak_14[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_minus_14) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_minus_14(i, CPG_Params_cpp.Bk_minus_14[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_plus_14) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_plus_14(i, CPG_Params_cpp.Bk_plus_14[i]);
        }
    }
    if (CPG_Updated_cpp.Ak_15) {
        for(i=0; i<49; i++) {
            cpg_update_Ak_15(i, CPG_Params_cpp.Ak_15[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_minus_15) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_minus_15(i, CPG_Params_cpp.Bk_minus_15[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_plus_15) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_plus_15(i, CPG_Params_cpp.Bk_plus_15[i]);
        }
    }
    if (CPG_Updated_cpp.Ak_16) {
        for(i=0; i<49; i++) {
            cpg_update_Ak_16(i, CPG_Params_cpp.Ak_16[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_minus_16) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_minus_16(i, CPG_Params_cpp.Bk_minus_16[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_plus_16) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_plus_16(i, CPG_Params_cpp.Bk_plus_16[i]);
        }
    }
    if (CPG_Updated_cpp.Ak_17) {
        for(i=0; i<49; i++) {
            cpg_update_Ak_17(i, CPG_Params_cpp.Ak_17[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_minus_17) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_minus_17(i, CPG_Params_cpp.Bk_minus_17[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_plus_17) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_plus_17(i, CPG_Params_cpp.Bk_plus_17[i]);
        }
    }
    if (CPG_Updated_cpp.Ak_18) {
        for(i=0; i<49; i++) {
            cpg_update_Ak_18(i, CPG_Params_cpp.Ak_18[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_minus_18) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_minus_18(i, CPG_Params_cpp.Bk_minus_18[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_plus_18) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_plus_18(i, CPG_Params_cpp.Bk_plus_18[i]);
        }
    }
    if (CPG_Updated_cpp.Ak_19) {
        for(i=0; i<49; i++) {
            cpg_update_Ak_19(i, CPG_Params_cpp.Ak_19[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_minus_19) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_minus_19(i, CPG_Params_cpp.Bk_minus_19[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_plus_19) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_plus_19(i, CPG_Params_cpp.Bk_plus_19[i]);
        }
    }
    if (CPG_Updated_cpp.Ak_20) {
        for(i=0; i<49; i++) {
            cpg_update_Ak_20(i, CPG_Params_cpp.Ak_20[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_minus_20) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_minus_20(i, CPG_Params_cpp.Bk_minus_20[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_plus_20) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_plus_20(i, CPG_Params_cpp.Bk_plus_20[i]);
        }
    }
    if (CPG_Updated_cpp.Ak_21) {
        for(i=0; i<49; i++) {
            cpg_update_Ak_21(i, CPG_Params_cpp.Ak_21[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_minus_21) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_minus_21(i, CPG_Params_cpp.Bk_minus_21[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_plus_21) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_plus_21(i, CPG_Params_cpp.Bk_plus_21[i]);
        }
    }
    if (CPG_Updated_cpp.Ak_22) {
        for(i=0; i<49; i++) {
            cpg_update_Ak_22(i, CPG_Params_cpp.Ak_22[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_minus_22) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_minus_22(i, CPG_Params_cpp.Bk_minus_22[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_plus_22) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_plus_22(i, CPG_Params_cpp.Bk_plus_22[i]);
        }
    }
    if (CPG_Updated_cpp.Ak_23) {
        for(i=0; i<49; i++) {
            cpg_update_Ak_23(i, CPG_Params_cpp.Ak_23[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_minus_23) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_minus_23(i, CPG_Params_cpp.Bk_minus_23[i]);
        }
    }
    if (CPG_Updated_cpp.Bk_plus_23) {
        for(i=0; i<21; i++) {
            cpg_update_Bk_plus_23(i, CPG_Params_cpp.Bk_plus_23[i]);
        }
    }
...
PYBIND11_MODULE(cpg_module, m) {
    ...
    py::class_<CPG_Params_cpp_t>(m, "cpg_params")
            ...
            .def_readwrite("Ak_14", &CPG_Params_cpp_t::Ak_14)
            .def_readwrite("Bk_minus_14", &CPG_Params_cpp_t::Bk_minus_14)
            .def_readwrite("Bk_plus_14", &CPG_Params_cpp_t::Bk_plus_14)
            .def_readwrite("Ak_15", &CPG_Params_cpp_t::Ak_15)
            .def_readwrite("Bk_minus_15", &CPG_Params_cpp_t::Bk_minus_15)
            .def_readwrite("Bk_plus_15", &CPG_Params_cpp_t::Bk_plus_15)
            .def_readwrite("Ak_16", &CPG_Params_cpp_t::Ak_16)
            .def_readwrite("Bk_minus_16", &CPG_Params_cpp_t::Bk_minus_16)
            .def_readwrite("Bk_plus_16", &CPG_Params_cpp_t::Bk_plus_16)
            .def_readwrite("Ak_17", &CPG_Params_cpp_t::Ak_17)
            .def_readwrite("Bk_minus_17", &CPG_Params_cpp_t::Bk_minus_17)
            .def_readwrite("Bk_plus_17", &CPG_Params_cpp_t::Bk_plus_17)
            .def_readwrite("Ak_18", &CPG_Params_cpp_t::Ak_18)
            .def_readwrite("Bk_minus_18", &CPG_Params_cpp_t::Bk_minus_18)
            .def_readwrite("Bk_plus_18", &CPG_Params_cpp_t::Bk_plus_18)
            .def_readwrite("Ak_19", &CPG_Params_cpp_t::Ak_19)
            .def_readwrite("Bk_minus_19", &CPG_Params_cpp_t::Bk_minus_19)
            .def_readwrite("Bk_plus_19", &CPG_Params_cpp_t::Bk_plus_19)
            .def_readwrite("Ak_20", &CPG_Params_cpp_t::Ak_20)
            .def_readwrite("Bk_minus_20", &CPG_Params_cpp_t::Bk_minus_20)
            .def_readwrite("Bk_plus_20", &CPG_Params_cpp_t::Bk_plus_20)
            .def_readwrite("Ak_21", &CPG_Params_cpp_t::Ak_21)
            .def_readwrite("Bk_minus_21", &CPG_Params_cpp_t::Bk_minus_21)
            .def_readwrite("Bk_plus_21", &CPG_Params_cpp_t::Bk_plus_21)
            .def_readwrite("Ak_22", &CPG_Params_cpp_t::Ak_22)
            .def_readwrite("Bk_minus_22", &CPG_Params_cpp_t::Bk_minus_22)
            .def_readwrite("Bk_plus_22", &CPG_Params_cpp_t::Bk_plus_22)
            .def_readwrite("Ak_23", &CPG_Params_cpp_t::Ak_23)
            .def_readwrite("Bk_minus_23", &CPG_Params_cpp_t::Bk_minus_23)
            .def_readwrite("Bk_plus_23", &CPG_Params_cpp_t::Bk_plus_23)
    ...
    py::class_<CPG_Updated_cpp_t>(m, "cpg_updated")
            ...
            .def_readwrite("Ak_14", &CPG_Updated_cpp_t::Ak_14)
            .def_readwrite("Bk_minus_14", &CPG_Updated_cpp_t::Bk_minus_14)
            .def_readwrite("Bk_plus_14", &CPG_Updated_cpp_t::Bk_plus_14)
            .def_readwrite("Ak_15", &CPG_Updated_cpp_t::Ak_15)
            .def_readwrite("Bk_minus_15", &CPG_Updated_cpp_t::Bk_minus_15)
            .def_readwrite("Bk_plus_15", &CPG_Updated_cpp_t::Bk_plus_15)
            .def_readwrite("Ak_16", &CPG_Updated_cpp_t::Ak_16)
            .def_readwrite("Bk_minus_16", &CPG_Updated_cpp_t::Bk_minus_16)
            .def_readwrite("Bk_plus_16", &CPG_Updated_cpp_t::Bk_plus_16)
            .def_readwrite("Ak_17", &CPG_Updated_cpp_t::Ak_17)
            .def_readwrite("Bk_minus_17", &CPG_Updated_cpp_t::Bk_minus_17)
            .def_readwrite("Bk_plus_17", &CPG_Updated_cpp_t::Bk_plus_17)
            .def_readwrite("Ak_18", &CPG_Updated_cpp_t::Ak_18)
            .def_readwrite("Bk_minus_18", &CPG_Updated_cpp_t::Bk_minus_18)
            .def_readwrite("Bk_plus_18", &CPG_Updated_cpp_t::Bk_plus_18)
            .def_readwrite("Ak_19", &CPG_Updated_cpp_t::Ak_19)
            .def_readwrite("Bk_minus_19", &CPG_Updated_cpp_t::Bk_minus_19)
            .def_readwrite("Bk_plus_19", &CPG_Updated_cpp_t::Bk_plus_19)
            .def_readwrite("Ak_20", &CPG_Updated_cpp_t::Ak_20)
            .def_readwrite("Bk_minus_20", &CPG_Updated_cpp_t::Bk_minus_20)
            .def_readwrite("Bk_plus_20", &CPG_Updated_cpp_t::Bk_plus_20)
            .def_readwrite("Ak_21", &CPG_Updated_cpp_t::Ak_21)
            .def_readwrite("Bk_minus_21", &CPG_Updated_cpp_t::Bk_minus_21)
            .def_readwrite("Bk_plus_21", &CPG_Updated_cpp_t::Bk_plus_21)
            .def_readwrite("Ak_22", &CPG_Updated_cpp_t::Ak_22)
            .def_readwrite("Bk_minus_22", &CPG_Updated_cpp_t::Bk_minus_22)
            .def_readwrite("Bk_plus_22", &CPG_Updated_cpp_t::Bk_plus_22)
            .def_readwrite("Ak_23", &CPG_Updated_cpp_t::Ak_23)
            .def_readwrite("Bk_minus_23", &CPG_Updated_cpp_t::Bk_minus_23)
            .def_readwrite("Bk_plus_23", &CPG_Updated_cpp_t::Bk_plus_23)
