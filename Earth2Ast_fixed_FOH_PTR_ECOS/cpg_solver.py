...
from Earth2Ast_fixed_FOH_PTR_ECOS import cpg_module
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    if updated_params is None:
        updated_params = ["Ak_0", "Bk_minus_0", "Bk_plus_0", "ck", "Ak_1", "Bk_minus_1", "Bk_plus_1", "Ak_2", "Bk_minus_2", "Bk_plus_2", "Ak_3", "Bk_minus_3", "Bk_plus_3", "Ak_4", "Bk_minus_4", "Bk_plus_4", "Ak_5", "Bk_minus_5", "Bk_plus_5", "Ak_6", "Bk_minus_6", "Bk_plus_6", "Ak_7", "Bk_minus_7", "Bk_plus_7", "Ak_8", "Bk_minus_8", "Bk_plus_8", "Ak_9", "Bk_minus_9", "Bk_plus_9", "Ak_10", "Bk_minus_10", "Bk_plus_10", "Ak_11", "Bk_minus_11", "Bk_plus_11", "Ak_12", "Bk_minus_12", "Bk_plus_12", "Ak_13", "Bk_minus_13", "Bk_plus_13", "Ak_14", "Bk_minus_14", "Bk_plus_14", "Ak_15", "Bk_minus_15", "Bk_plus_15", "Ak_16", "Bk_minus_16", "Bk_plus_16", "Ak_17", "Bk_minus_17", "Bk_plus_17", "Ak_18", "Bk_minus_18", "Bk_plus_18", "Ak_19", "Bk_minus_19", "Bk_plus_19", "Ak_20", "Bk_minus_20", "Bk_plus_20", "Ak_21", "Bk_minus_21", "Bk_plus_21", "Ak_22", "Bk_minus_22", "Bk_plus_22", "Ak_23", "Bk_minus_23", "Bk_plus_23", "x_0", "x_f", "x_ref", "u_ref"]
    ...
    par.Ak_14 = list(param_dict["Ak_14"].value.flatten(order="F"))
    par.Bk_minus_14 = list(param_dict["Bk_minus_14"].value.flatten(order="F"))
    par.Bk_plus_14 = list(param_dict["Bk_plus_14"].value.flatten(order="F"))
    par.Ak_15 = list(param_dict["Ak_15"].value.flatten(order="F"))
    par.Bk_minus_15 = list(param_dict["Bk_minus_15"].value.flatten(order="F"))
    par.Bk_plus_15 = list(param_dict["Bk_plus_15"].value.flatten(order="F"))
    par.Ak_16 = list(param_dict["Ak_16"].value.flatten(order="F"))
    par.Bk_minus_16 = list(param_dict["Bk_minus_16"].value.flatten(order="F"))
    par.Bk_plus_16 = list(param_dict["Bk_plus_16"].value.flatten(order="F"))
    par.Ak_17 = list(param_dict["Ak_17"].value.flatten(order="F"))
    par.Bk_minus_17 = list(param_dict["Bk_minus_17"].value.flatten(order="F"))
    par.Bk_plus_17 = list(param_dict["Bk_plus_17"].value.flatten(order="F"))
    par.Ak_18 = list(param_dict["Ak_18"].value.flatten(order="F"))
    par.Bk_minus_18 = list(param_dict["Bk_minus_18"].value.flatten(order="F"))
    par.Bk_plus_18 = list(param_dict["Bk_plus_18"].value.flatten(order="F"))
    par.Ak_19 = list(param_dict["Ak_19"].value.flatten(order="F"))
    par.Bk_minus_19 = list(param_dict["Bk_minus_19"].value.flatten(order="F"))
    par.Bk_plus_19 = list(param_dict["Bk_plus_19"].value.flatten(order="F"))
    par.Ak_20 = list(param_dict["Ak_20"].value.flatten(order="F"))
    par.Bk_minus_20 = list(param_dict["Bk_minus_20"].value.flatten(order="F"))
    par.Bk_plus_20 = list(param_dict["Bk_plus_20"].value.flatten(order="F"))
    par.Ak_21 = list(param_dict["Ak_21"].value.flatten(order="F"))
    par.Bk_minus_21 = list(param_dict["Bk_minus_21"].value.flatten(order="F"))
    par.Bk_plus_21 = list(param_dict["Bk_plus_21"].value.flatten(order="F"))
    par.Ak_22 = list(param_dict["Ak_22"].value.flatten(order="F"))
    par.Bk_minus_22 = list(param_dict["Bk_minus_22"].value.flatten(order="F"))
    par.Bk_plus_22 = list(param_dict["Bk_plus_22"].value.flatten(order="F"))
    par.Ak_23 = list(param_dict["Ak_23"].value.flatten(order="F"))
    par.Bk_minus_23 = list(param_dict["Bk_minus_23"].value.flatten(order="F"))
    par.Bk_plus_23 = list(param_dict["Bk_plus_23"].value.flatten(order="F"))
    ...
    prob.var_dict['U'].save_value(np.array(res.cpg_prim.U).reshape((3, 25), order='F'))
    prob.var_dict['V'].save_value(np.array(res.cpg_prim.V).reshape((7, 24), order='F'))
    ...
    prob.var_dict['eta'].save_value(np.array(res.cpg_prim.eta).reshape((1, 25), order='F'))
    prob.var_dict['X'].save_value(np.array(res.cpg_prim.X).reshape((7, 25), order='F'))
    prob.var_dict['p'].save_value(np.array(res.cpg_prim.p).reshape((3, 1), order='F'))
    ...
    prob.constraints[14].save_dual_value(np.array(res.cpg_dual.d14).reshape(7))
    prob.constraints[15].save_dual_value(np.array(res.cpg_dual.d15).reshape(7))
    prob.constraints[16].save_dual_value(np.array(res.cpg_dual.d16).reshape(7))
    prob.constraints[17].save_dual_value(np.array(res.cpg_dual.d17).reshape(7))
    prob.constraints[18].save_dual_value(np.array(res.cpg_dual.d18).reshape(7))
    prob.constraints[19].save_dual_value(np.array(res.cpg_dual.d19).reshape(7))
    prob.constraints[20].save_dual_value(np.array(res.cpg_dual.d20).reshape(7))
    prob.constraints[21].save_dual_value(np.array(res.cpg_dual.d21).reshape(7))
    prob.constraints[22].save_dual_value(np.array(res.cpg_dual.d22).reshape(7))
    prob.constraints[23].save_dual_value(np.array(res.cpg_dual.d23).reshape(7))
    prob.constraints[24].save_dual_value(np.array(res.cpg_dual.d24).reshape(25))
    prob.constraints[25].save_dual_value(np.array(res.cpg_dual.d25).reshape(25))
    prob.constraints[26].save_dual_value(np.array(res.cpg_dual.d26))
    prob.constraints[27].save_dual_value(np.array(res.cpg_dual.d27).reshape((3, 3), order='F'))
    prob.constraints[28].save_dual_value(np.array(res.cpg_dual.d28).reshape((3, 3), order='F'))
    prob.constraints[29].save_dual_value(np.array(res.cpg_dual.d29).reshape(1))
    prob.constraints[30].save_dual_value(np.array(res.cpg_dual.d30).reshape((6, 6), order='F'))
    prob.constraints[31].save_dual_value(np.array(res.cpg_dual.d31).reshape((1, 25), order='F'))
...
def cpg_gradient(prob, gradient_sol_primal=None, gradient_sol_dual=None):
    ...
    if gradient_sol_primal is not None and gradient_sol_dual is not None:
        ...
        gradient_sol.primal = [0] * 718
        gradient_sol.dual = [0] * 1213
        use_sol = False
    ...
    vdelta.p = list(prob.var_dict["p"].gradient.flatten(order="F"))
    ...
    prob.param_dict['ck'].gradient = np.array(pdelta.ck).reshape((7, 24), order='F')
    ...
    prob.param_dict['Ak_14'].gradient = np.array(pdelta.Ak_14).reshape((7, 7), order='F')
    prob.param_dict['Bk_minus_14'].gradient = np.array(pdelta.Bk_minus_14).reshape((7, 3), order='F')
    prob.param_dict['Bk_plus_14'].gradient = np.array(pdelta.Bk_plus_14).reshape((7, 3), order='F')
    prob.param_dict['Ak_15'].gradient = np.array(pdelta.Ak_15).reshape((7, 7), order='F')
    prob.param_dict['Bk_minus_15'].gradient = np.array(pdelta.Bk_minus_15).reshape((7, 3), order='F')
    prob.param_dict['Bk_plus_15'].gradient = np.array(pdelta.Bk_plus_15).reshape((7, 3), order='F')
    prob.param_dict['Ak_16'].gradient = np.array(pdelta.Ak_16).reshape((7, 7), order='F')
    prob.param_dict['Bk_minus_16'].gradient = np.array(pdelta.Bk_minus_16).reshape((7, 3), order='F')
    prob.param_dict['Bk_plus_16'].gradient = np.array(pdelta.Bk_plus_16).reshape((7, 3), order='F')
    prob.param_dict['Ak_17'].gradient = np.array(pdelta.Ak_17).reshape((7, 7), order='F')
    prob.param_dict['Bk_minus_17'].gradient = np.array(pdelta.Bk_minus_17).reshape((7, 3), order='F')
    prob.param_dict['Bk_plus_17'].gradient = np.array(pdelta.Bk_plus_17).reshape((7, 3), order='F')
    prob.param_dict['Ak_18'].gradient = np.array(pdelta.Ak_18).reshape((7, 7), order='F')
    prob.param_dict['Bk_minus_18'].gradient = np.array(pdelta.Bk_minus_18).reshape((7, 3), order='F')
    prob.param_dict['Bk_plus_18'].gradient = np.array(pdelta.Bk_plus_18).reshape((7, 3), order='F')
    prob.param_dict['Ak_19'].gradient = np.array(pdelta.Ak_19).reshape((7, 7), order='F')
    prob.param_dict['Bk_minus_19'].gradient = np.array(pdelta.Bk_minus_19).reshape((7, 3), order='F')
    prob.param_dict['Bk_plus_19'].gradient = np.array(pdelta.Bk_plus_19).reshape((7, 3), order='F')
    prob.param_dict['Ak_20'].gradient = np.array(pdelta.Ak_20).reshape((7, 7), order='F')
    prob.param_dict['Bk_minus_20'].gradient = np.array(pdelta.Bk_minus_20).reshape((7, 3), order='F')
    prob.param_dict['Bk_plus_20'].gradient = np.array(pdelta.Bk_plus_20).reshape((7, 3), order='F')
    prob.param_dict['Ak_21'].gradient = np.array(pdelta.Ak_21).reshape((7, 7), order='F')
    prob.param_dict['Bk_minus_21'].gradient = np.array(pdelta.Bk_minus_21).reshape((7, 3), order='F')
    prob.param_dict['Bk_plus_21'].gradient = np.array(pdelta.Bk_plus_21).reshape((7, 3), order='F')
    prob.param_dict['Ak_22'].gradient = np.array(pdelta.Ak_22).reshape((7, 7), order='F')
    prob.param_dict['Bk_minus_22'].gradient = np.array(pdelta.Bk_minus_22).reshape((7, 3), order='F')
    prob.param_dict['Bk_plus_22'].gradient = np.array(pdelta.Bk_plus_22).reshape((7, 3), order='F')
    prob.param_dict['Ak_23'].gradient = np.array(pdelta.Ak_23).reshape((7, 7), order='F')
    prob.param_dict['Bk_minus_23'].gradient = np.array(pdelta.Bk_minus_23).reshape((7, 3), order='F')
    prob.param_dict['Bk_plus_23'].gradient = np.array(pdelta.Bk_plus_23).reshape((7, 3), order='F')
    prob.param_dict['x_0'].gradient = np.array(pdelta.x_0).reshape((7, 1), order='F')
    prob.param_dict['x_f'].gradient = np.array(pdelta.x_f).reshape((6, 1), order='F')
    prob.param_dict['x_ref'].gradient = np.array(pdelta.x_ref).reshape((7, 25), order='F')
    prob.param_dict['u_ref'].gradient = np.array(pdelta.u_ref).reshape((3, 25), order='F')
