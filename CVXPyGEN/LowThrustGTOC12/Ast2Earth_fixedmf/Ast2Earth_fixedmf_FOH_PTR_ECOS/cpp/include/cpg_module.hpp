...
struct CPG_Params_cpp_t {
    ...
    std::array<double, 6> x_0;
    std::array<double, 7> x_f;
...
struct CPG_Prim_cpp_t {
    ...
    std::array<double, 6> v_0;
    std::array<double, 7> v_N;
...
struct CPG_Dual_cpp_t {
    ...
    double d16;
    std::array<double, 36> d17;
    std::array<double, 9> d18;
    std::array<double, 9> d19;
    double d20;
    std::array<double, 15> d21;
};
