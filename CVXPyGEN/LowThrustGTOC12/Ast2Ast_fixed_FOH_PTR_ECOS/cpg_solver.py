...
from C:.Users.thatf.OneDrive.Documents.ASA.PSP-ASA-GTOC12-Problem.CVXPyGEN.LowThrustGTOC12.Ast2Ast_fixed_FOH_PTR_ECOS import cpg_module
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    prob.constraints[16].save_dual_value(np.array(res.cpg_dual.d16).reshape((7, 7), order='F'))
