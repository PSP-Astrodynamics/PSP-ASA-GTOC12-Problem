...
if not load:
    ...
    loaded_data = np.load(r'C:\Users\thatf\OneDrive\Documents\ASA\PSP-ASA-GTOC12-Problem\CVXPyGEN\LowThrustGTOC12\Ast2Ast_fixedmf\saved_Ast2Ast_fixedmf_input_FOH.npz', allow_pickle=True)
    ...
    # Saved Problem
    dbfile = open(r'C:\Users\thatf\OneDrive\Documents\ASA\PSP-ASA-GTOC12-Problem\CVXPyGEN\LowThrustGTOC12\Ast2Ast_fixedmf\Ast2Ast_fixedmf_prob_FOH', 'rb')    
...
if str(type(problem)) == "<class 'array.array'>" or str(type(problem)) == "<class 'numpy.ndarray'>":
    ...
    constraints = dynamics_constraints + [ # Dynamics constraint
                   ...
                   X[:, N] + v_N == x_f_param.flatten(), # Terminal condition constraint
...
if save:
    np.savez(r'C:\Users\thatf\OneDrive\Documents\ASA\PSP-ASA-GTOC12-Problem\CVXPyGEN\LowThrustGTOC12\Ast2Ast_fixedmf\saved_Ast2Ast_fixedmf_input_FOH.npz', A_k = A_k, B_k_minus = B_k_minus, B_k_plus = B_k_plus, c_k = c_k, w_vc = w_vc, w_tr = w_tr, delta_t = delta_t, N = N, x_0 = x_0, x_f = x_f, x_ref = x_ref, u_ref = u_ref)
    
    dbfile = open(r'C:\Users\thatf\OneDrive\Documents\ASA\PSP-ASA-GTOC12-Problem\CVXPyGEN\LowThrustGTOC12\Ast2Ast_fixedmf\Ast2Ast_fixedmf_prob_FOH', 'ab')
...
#cpg.generate_code(problem, code_dir='Ast2Ast_fixedmf_FOH_PTR_ECOS', solver = "ECOS")
...
# 
# from Ast2Ast_fixedmf_FOH_PTR_ECOS.cpg_solver import cpg_solve
# 
