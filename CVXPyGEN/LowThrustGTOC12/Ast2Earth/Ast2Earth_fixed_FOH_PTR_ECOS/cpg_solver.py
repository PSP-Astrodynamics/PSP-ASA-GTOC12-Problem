...
from Ast2Earth_fixed_FOH_PTR_ECOS import cpg_module
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    prob.constraints[20].save_dual_value(np.array(res.cpg_dual.d20).reshape((1, 15), order='F'))
